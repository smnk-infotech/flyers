...
- ✅ **Initial SEO & Social Metadata:** Added meta descriptions, absolute canonical URLs, Open Graph & Twitter Card tags to `Donation – Flyers Charitable Trust.html` and `Contact US – Flyers Charitable Trust.html` (rollout continuing)
...
- [ ] SEO optimization (remaining pages: meta tags, schema.org, JSON-LD)
...
**Version:** 1.1.1
**Change Note:** Added initial SEO & social meta to Donation and Contact pages; README updated to reflect partial rollout.
